...
export class AdminComponent implements OnInit {
  ...
  buildForm(){
    this.form = this.formBuilder.group({
      ...
      country:[this.selectedEnterprise.location?.country, Validators.required],
      state:[this.selectedEnterprise.location?.state, Validators.required],
      city:[this.selectedEnterprise.location?.city, Validators.required],
